...
$sql = "SELECT * FROM movies WHERE release_date = '$tomorrow_date'";
...
<body>
    ...
    <section class="now-showing">
        ...
        <div class="date-navigation">
            ...
            <button id="tomorrow" class="active">TOMORROW</button>
           <a href="specific-date.php"><button id="specific-date"></button></a>
        </div>
